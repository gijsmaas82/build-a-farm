...
test('We have a fully functioning farm', () => {
    ...
    expect(farm.calculateIncome()).toBeCloseTo(4204, 0)
})
...
//      const farm = new Farm('test')
//      farm.addAnimal(new Pig(100))
//      expect(farm.calculateIncome()).toBeCloseTo(920, 1)
//      })
